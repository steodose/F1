...
constructor_lineplot <- constructor_points2 %>% 
    ...
    scale_color_manual(values=c("#00D2BE", "#FF9B00", "#FF2800")) +
    labs(x = "Race",
         y = "Cumulative F1 Points",
         title = "The Race for the Constructors' Title",
         subtitle = "Cumulative points earned for each team by race. <span style = 'color:#00D2BE;'>**Mercedes**</span>, <span style = 'color:#FF9B00;'>**Red Bull**</span> and <span style = 'color:#FF2800;'>**Ferrari**</span> are highlighted since the Championship will likely come down to them.",
